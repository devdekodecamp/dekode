      ...
      <section className="pt-32 pb-16 px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center space-y-6">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto text-balance">
            Choose from our comprehensive programs designed to take you from beginner to job-ready professional
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <Card className="p-10 space-y-6 hover:shadow-xl transition-shadow bg-card">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                Comprehensive learning tracks designed to prepare you for specific tech careers with structured
                progression and real-world projects.
              </p>
            ...
            <Card className="p-10 space-y-6 hover:shadow-xl transition-shadow bg-card">
              ...
              <h2 className="text-3xl font-bold text-foreground">Salesforce ADM201</h2>
              <p className="text-lg text-muted-foreground leading-relaxed">
                Get certified as a Salesforce Administrator with our comprehensive ADM201 certification preparation
                program.
              </p>
      ...
      <section className="py-24 px-6 lg:px-8 bg-secondary">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16 space-y-4">
            <h2 className="text-4xl md:text-5xl font-bold text-balance">What You'll Gain</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-xl font-semibold mb-2 text-foreground">Expert Instruction</h3>
            ...
            <div className="flex items-start gap-4">
              <CheckCircle2 className="text-[#760da3] flex-shrink-0 mt-1" size={24} />
              <div>
                <h3 className="text-xl font-semibold mb-2 text-foreground">Hands-On Projects</h3>
                <p className="text-muted-foreground leading-relaxed">
            ...
            <div className="flex items-start gap-4">
              <CheckCircle2 className="text-[#760da3] flex-shrink-0 mt-1" size={24} />
              <div>
                <h3 className="text-xl font-semibold mb-2 text-foreground">Community Access</h3>
                <p className="text-muted-foreground leading-relaxed">
            ...
            <div className="flex items-start gap-4">
              <CheckCircle2 className="text-[#760da3] flex-shrink-0 mt-1" size={24} />
              <div>
                <h3 className="text-xl font-semibold mb-2 text-foreground">Certification Prep</h3>
                <p className="text-muted-foreground leading-relaxed">Prepare for industry-recognized certifications</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <p className="text-xl text-muted-foreground text-balance">
            Choose a program and begin your journey to a successful tech career today
          </p>
          <Link href="/contact">
            <Button
              size="lg"
