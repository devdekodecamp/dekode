      ...
      <section className="py-16 px-6 lg:px-8">
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <div className="space-y-6 text-lg text-muted-foreground leading-relaxed">
            <p>
              DeKode Camp began with a simple mission — to make learning tech
              and building digital solutions easier for everyone.
            </p>
            <p>
              Many aspiring professionals wanted to step into the tech world but
              were held back by the complexity of coding and the high cost of
              traditional training. DeKode Camp was created to bridge that gap.
            </p>
            <p>
              Focusing on low-code platforms like Salesforce, DeKode Camp helps
              learners build real-world solutions faster — without needing a
              deep programming background. Our approach is practical, hands-on,
              and career-driven, empowering learners to create value from day
              one.
            </p>
            <p>
              DeKode Camp continues to grow with one clear goal — to help more
              people unlock tech careers through accessible, low-code learning.
            </p>
            <p>
              At DeKode Camp, we believe you don't need to be a developer to
              build. You just need the right guidance — and the drive to start.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
            ...
            <Card className="p-10 space-y-6 bg-card border-2">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                To make learning tech simple, inclusive, and
                enjoyable—empowering anyone to start, shift, or grow their
            ...
            <Card className="p-10 space-y-6 bg-gradient-brand border-0">
              ...
              <p className="text-lg text-white leading-relaxed">
                A world where everyone, regardless of background, can understand
                technology and use it to build a brighter, more fulfilling
                future.
              </p>
            </Card>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16 space-y-4">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto text-balance">
              Our unique methodology combines theory with practice for optimal
              learning outcomes
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            <Card className="p-8 space-y-4 bg-card">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Master fundamental concepts through engaging video lessons,
                interactive tutorials, and comprehensive documentation.
              </p>
            </Card>
            ...
            <Card className="p-8 space-y-4 bg-card">
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                actual problems and demonstrate your skills.
              </p>
            </Card>
            ...
            <Card className="p-8 space-y-4 bg-card">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Get career support, interview preparation, and job placement
                assistance to launch your tech career successfully.
              </p>
            </Card>
          </div>
